                                        ...
                                        @if (!empty($products->toArray()['per_page']))
                                            @foreach ($products->toArray()['data'] as $key => $item)
                                                <tr>
                                                    ...
                                                    <td>{{ $item['quantity'] }}</td>
                                                    <td> <a name="id_pro"
                                                            href="edit_product/{{ $item['id_product'] }}"><i
                                                    ...
                                                    <form class="form-horizontal" method="get"
                                                        ...
                                                        <div class="modal-body">
                                                            <div class="form-group">
                                                                <label for="dummyText" class="control-label col-xs-4">Số
                                                                    lượng</label>
                                                        ...
                                                        <div class="modal-footer footer-popup">
                                                            <button
                                                                class="swal-button swal-button--cancel cancal-addproduct"
                                                                type="button">Cancel</button>
                                                            <a class="swal-button swal-button--confirm swal-button--danger"
                                                                id="btn-submit"> OK
                                                            </a>
...
<script type="text/javascript">
    ...
    // change url link
    const path = "/admin/import_product/{{ $item['id_product'] }}"
    btnSm.click(() => {
