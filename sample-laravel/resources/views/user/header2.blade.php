...
<div class="m-header d-flex align-items-center">
    ...
    <div class="d-flex header-right d-flex align-items-center">
        ...
        <a href="/profile" class="header-text me-3" style="color:black ;">Trần Huỳnh Điệp</a>

        <div class="m-icon-shopping"><a href="/user/giohang" style="color:black ;"><i class="fa-solid fa-cart-shopping"
